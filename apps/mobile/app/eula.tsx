    ...
    return (
        <ScrollView style={{ flex: 1 }}>
            <View style={{ padding: 20 }}>
                ...
                <Text variant="caption1" className="text-muted-foreground">Last Updated: March 19, 2024</Text>

                <Text variant="body" className="mt-4">
                    This End User License Agreement ("EULA") is a legal agreement between you ("User" or "You") and Sanity Island Inc. ("Company," "We," "Us," or "Our") for the use of the Olas application ("App"), an Instagram-like application built on Nostr. By downloading, installing, or using the App, you agree to be bound by the terms of this Agreement.
                </Text>

                <Text variant="title2" className="mt-6">Prohibited Content and Conduct</Text>
                <Text variant="body" className="mt-2">
                    You agree not to use our application to create, upload, post, send, or store any content that:
                </Text>
                <Text variant="body" className="mt-2 ml-4">
                ...
                <Text variant="title2" className="mt-6">Consequences of Violation</Text>
                <Text variant="body" className="mt-2">
                ...
                <Text variant="title2" className="mt-6">Disclaimer of Warranties and Limitation of Liability</Text>
                <Text variant="body" className="mt-2">
                    The App is provided "as is" and "as available" without warranties of any kind, whether express or implied. The Company does not warrant that the App will be error-free or uninterrupted. In no event shall Sanity Island Inc. be liable for any damages whatsoever, including but not limited to direct, indirect, special, incidental, or consequential damages, arising out of or in connection with the use or inability to use our application.
                </Text>

                <Text variant="title2" className="mt-6">Changes to EULA</Text>
                <Text variant="body" className="mt-2">
                ...
                <Text variant="title2" className="mt-6">Contact Information</Text>
                <Text variant="body" className="mt-2">
                    If you have any questions about this EULA, please contact us at support@olas.app
                </Text>

                <Text variant="title2" className="mt-6">Acceptance of Terms</Text>
                <Text variant="body" className="mt-2 mb-8">
                    By using the Olas app, you signify your acceptance of this EULA. If you do not agree to this EULA, you may not use our Application.
                </Text>
            </View>
        </ScrollView>
    );
