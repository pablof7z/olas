...
export function PromptForNotifications() {
    ...
    const visible = useMemo(() => !!eventForPrompt && !promptedForNotifications && permissionStatus !== 'granted', [promptedForNotifications, eventForPrompt, permissionStatus]);

    return <EnableNotificationsModal
        visible={visible}
        onClose={() => {
