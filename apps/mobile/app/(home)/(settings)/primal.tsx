...
const SvgComponent = ({ size, ...props }: { size: number }) => (
    ...
    >
        <G clipPath="url(#a)">
            ...
            <G filter="url(#b)">
                <Circle cx={340} cy={127.5} r={112.5} fill="#BD1971" fillOpacity={0.85} />
            </G>
            <G filter="url(#c)">
                <Circle cx={102.5} cy={322.5} r={112.5} fill="#610AAA" fillOpacity={0.9} />
            </G>
            <G filter="url(#d)">
                <Ellipse cx={50} cy={-32.5} fill="#FFA02F" fillOpacity={0.8} rx={100} ry={87.5} />
            </G>
            <G filter="url(#e)">
                <Path
                    fill="url(#f)"
