...
import { StyleProp, StyleSheet, TextInput, View, ViewStyle, TextStyle } from 'react-native';
import { atom, useAtom, useAtomValue, useSetAtom } from 'jotai';
import { BottomSheetModal, BottomSheetTextInput, BottomSheetView } from '@gorhom/bottom-sheet';
import { captionBottomSheetRefAtom, useEditorStore } from '@/lib/publish/store/editor';
