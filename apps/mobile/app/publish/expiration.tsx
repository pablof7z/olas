...
export default function Caption() {
    ...
    const [date, setDate] = useState(
        new Date(expiration ?? new Date().getTime() + 1000 * 60 * 60 * 24)
    );
        ...
        <>
            ...
            <View className="w-full flex-col items-center justify-between gap-10 p-4">
                <Text className="text-sm">
                    You can set an expiration date for your post; relays will be
                    instructed to delete the post after this date.
                </Text>
