...
export default function Caption() {
  ...
  return (
    <>
        <Stack.Screen options={{ headerShown: true, title: 'Expiration', headerRight: () => <Button title="OK" onPress={() => { setExpiration(date.getTime()); router.back(); }} /> }} />
          <View className="w-full p-4 flex-col justify-between items-center gap-10">
              ...
              />
                ...
                <ButtonComponent variant="tonal" onPress={() => { setExpiration(0); router.back(); }}>
