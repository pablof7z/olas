...
export default function NotificationItem({ event, currentUser }: { event: NDKEvent, currentUser: NDKUser }) {
    ...
    switch (event.kind) {
        case NDKKind.GenericRepost: label = 'reposted you'; break;
        case NDKKind.Reaction: label = 'reacted to your post'; break;
        case NDKKind.Text: case NDKKind.GenericReply: label = getLabelForCommentNotification(event, currentUser); break;
        case NDKKind.Zap: label = 'LN zapped you'; break;
        case NDKKind.Nutzap: label = 'zapped you'; break;
        case 3006: label = 'bookmarked your post'; break;
        case 967: label = 'followed you'; break;
        default: label = event.kind.toString();
    }
