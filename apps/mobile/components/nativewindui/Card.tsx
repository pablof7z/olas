...
const CardBadge = React.forwardRef<React.ElementRef<typeof View>, React.ComponentPropsWithoutRef<typeof View>>(
...
const CardFooter = React.forwardRef<React.ElementRef<typeof BlurView>, React.ComponentPropsWithoutRef<typeof BlurView>>(
    ({ className, ...props }, ref) => (
        <BlurView
            ref={ref}
