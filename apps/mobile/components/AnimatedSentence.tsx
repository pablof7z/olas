...
export const AnimatedSentence = memo(({ children, onExitFinish, onEnterFinish, stagger = 100, ...rest }: AnimatedSentenceProps) => {
                    ...
                    <Animated.Text
                        entering={SlideInDown.springify()
                            ...
                            .withCallback((finished) => {
                                if (finished && index === words.length - 1 && onEnterFinish && children !== '') {
                        ...
                        exiting={FadeOut.springify()
                            ...
                            .stiffness(200)
                            .withCallback((finished) => {
                                if (finished && index === words.length - 1 && onExitFinish && children !== '') {
