...
function ExpirationContent() {
    ...
    const handleSelect = useCallback((value: number | null) => {
...
function ExpirationOptionItem({ label, value, currentValue, onPress }: { label: string, value: number | null, currentValue: number | null, onPress: () => void }) {
    const { colors } = useColorScheme();
