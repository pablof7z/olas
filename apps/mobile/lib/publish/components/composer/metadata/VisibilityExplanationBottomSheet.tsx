...
const VisibilityExplanationBottomSheet = forwardRef<VisibilityExplanationBottomSheetRef>((_, ref) => {
                ...
                <View style={infoSheetStyles.contentContainer}>
                    ...
                    <View style={infoSheetStyles.section}>
                        ...
                        <Text style={[infoSheetStyles.description, { color: colors.muted }]}>
                            As a media post, your post will appear in visual-first apps.
                            A subset of apps can display these posts, but they are always displayed within the context of people who want to see them.
                        </Text>
                    ...
                    <View style={infoSheetStyles.section}>
                        ...
                        <Text style={[infoSheetStyles.description, { color: colors.muted }]}>
                            As a text post, your post will appear in text-first apps, in a high-velocity feed.
                            You will see more reach, but it will be mixed with lower-quality posts from other users.
                        </Text>
                        <Text style={{ fontSize: 12, color: colors.muted, fontWeight: '500' }}> 
