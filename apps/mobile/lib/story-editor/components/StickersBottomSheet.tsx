            ...
            <BottomSheetView style={[styles.container, { paddingBottom: insets.bottom }]}>
                ...
                {editStickerType === NDKStoryStickerType.Pubkey && (
                    <>
                        ...
                        <MentionStickerInput onStickerAdded={handleStickerAdded} />
                    </>
                )}
                ...
                {editStickerType === NDKStoryStickerType.Event && (
                    <>
                        ...
                        <EventStickerInput onStickerAdded={handleStickerAdded} />
                    </>
                )}
                ...
                {editStickerType === NDKStoryStickerType.Countdown && (
                    <>
                        ...
                        <CountdownStickerInput onStickerAdded={handleStickerAdded} />
                    </>
                )}
                ...
                {editStickerType === NDKStoryStickerType.Prompt && (
                    <>
                        ...
                        <PromptStickerInput onStickerAdded={handleStickerAdded} />
                    </>
                )}
            </BottomSheetView>
        </Sheet>
